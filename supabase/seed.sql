...
-- Oposición: Auxiliar Administrativo del Estado (C2)
...
-- ===========================================
-- TEMAS DEL BLOQUE I: Organización del Estado
-- ===========================================
...
-- ===========================================
-- TEMAS DEL BLOQUE II: Organización de Oficinas
-- ===========================================
...
-- ===========================================
-- TEMAS DEL BLOQUE III: Actividad Administrativa
-- ===========================================
...
-- Preguntas del Tema 1: La Constitución Española
...
-- Pregunta 1: Fecha aprobación CE
...
-- Pregunta 3: Estado social y democrático
INSERT INTO respuestas (pregunta_id, texto, es_correcta, orden) VALUES
...
-- Pregunta 6: Número de artículos
INSERT INTO respuestas (pregunta_id, texto, es_correcta, orden) VALUES
...
-- Pregunta 10: Título de derechos fundamentales
INSERT INTO respuestas (pregunta_id, texto, es_correcta, orden) VALUES
...
-- ===========================================
-- PREGUNTAS ADICIONALES: PROCEDIMIENTO ADMINISTRATIVO
-- ===========================================
...
-- Respuestas procedimiento administrativo
INSERT INTO respuestas (pregunta_id, texto, es_correcta, orden) VALUES
...
-- ===========================================
-- Seed completado correctamente para Auxiliar Administrativo del Estado
-- Total: 1 oposición, 4 bloques, 16 temas, 13 preguntas con respuestas
